function [ret]=catenaryEigenPerturb(nr,D,R,t,z,za,zb,D1,D2,p,Dpgl,Dppar,DpRgl,DpRpar,zc)
...
switch nr
     ...
     case 'x1'
         ret=1:0.01:2;
     case 'g'
         ret=[z(1,3)-((z(1,2)^2+1)/(z(1,1)-(0.234)))];
     case 'Dg'
         switch D
          case 1
                 ret=[(z(1,2)^2+1)/(z(1,1)-117/500)^2 ;];
          case 2
                 ret=[-(2*z(1,2))/(z(1,1)-117/500) ;];
          case 3
                 ret=[1 ;];
         end
     case 'Dpg'
