function [smeshNew, aw1, aw2, aw3, aw4, aw5, aw6, aw7, awEVP, awInf, awEP, awAuto]...
    = GenerateProb3ODESysMeshTruncated(xmesh, smeshOld, calc_aw, lambda, aL,y1,y2) 
...
if isstring(lambda) == 0
    ...
    denominator = strcat(num2str(lambda),"+ z2");
    ...
    %arc length dependent velocity new
...
if calc_aw(7) % antwort7, Define Boundary Condition
    %aw7 = strcat("[z1(a) =",num2str(y1),";z1(b) = ",num2str(y2),";z2(a) = 0;z3(a) = 0; z4(a) = 0;z5(b) = 0;]");
    aw7 = strcat("[z1(a) =",num2str(y1),";z1(b) = ",num2str(y2),";z2(b) = 0;]");
end
